...
import jdk.jfr.events.UnsafeAllocateMemoryEvent;
import jdk.jfr.events.UnsafeFreeMemoryEvent;
import jdk.jfr.events.UnsafeReallocateMemoryEvent;
...
final class MirrorEvents {
    ...
    static {
        ...
        register("jdk.internal.event.UnsafeAllocateMemoryEvent", UnsafeAllocateMemoryEvent.class);
        register("jdk.internal.event.UnsafeFreeMemoryEvent", UnsafeFreeMemoryEvent.class);
        register("jdk.internal.event.UnsafeReallocateMemoryEvent", UnsafeReallocateMemoryEvent.class);
